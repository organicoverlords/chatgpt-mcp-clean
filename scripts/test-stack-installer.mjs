...
assert.match(serverSource, /registerArtifactFileResource\(server, callerId\)/);
...
assert.doesNotMatch(fileTransferSource, /openai\/fileParams/, "inbound ChatGPT file params must stay absent from the MCP surface");
