...
const bridgeSetting = (process.env.MCP_LIBRARY_SPOOL_BRIDGE || "").trim();
const librarySpoolBridgeEnabled = bridgeSetting !== "0" && (bridgeSetting === "1" || (process.env.MCP_RUNTIME_INSTANCE_ID || "").startsWith("issue333-persistent-widget-"));
