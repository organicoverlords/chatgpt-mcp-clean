...
try {
  ...
  assert.match(wrapperSource, /Restart-CaddyFromPersistentConfig \$original \$rollbackProofHost \$rollbackProofPort/);
  assert.match(wrapperSource, /Assert-OriginalRoute \$rollbackProofHost \$rollbackProofPort/);
