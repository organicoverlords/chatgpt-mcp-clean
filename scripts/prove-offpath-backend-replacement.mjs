...
try {
  ...
  assert.deepEqual(beforeTools, ["download_chatgpt_file", "kill_process", "read_output", "start_process", "upload_local_file"], "off-path production proof must exercise only the deployed ChatGPT connector-tool surface");
