...
assert.equal(server._registeredTools.upload_local_file?._meta?.["openai/outputTemplate"], "ui://process/file-transfer-v7.html", "existing upload_local_file action must bootstrap the bridge when new tool registration is filtered by the host");
