...
console.log("PASS persistent_visual_bridge one_tool_mount=true polling=true exact_hash=true resource_message=true per_proof_upload=false ack_after_message=true");
